import googlemaps
        ...
        import googlemaps
        from datetime import datetime
        import dateutil.parser #import parser, parse
...
def get_loc_category(gmaps_response):
    """
     If any location level for the geocoded location matches one of the ones we are trying to highlight, return its short name
